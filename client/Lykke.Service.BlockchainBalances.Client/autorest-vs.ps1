...
autorest --input-file=http://localhost:5000/swagger/v1/swagger.json --csharp --output-folder=./client/Lykke.Service.BlockchainBalances.Client/AutorestClient --namespace=Lykke.Service.BlockchainBalances.Client.AutorestClient